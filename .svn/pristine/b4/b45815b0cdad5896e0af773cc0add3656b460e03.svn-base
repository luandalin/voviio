...
$(document).ready(function() {
	...
	var useFrequencyDataURL  = "<?php echo site_url();?>/report/usefrequency/getUserFrequencyData";
	renderCharts(useFrequencyDataURL);
});
...
{	
	...
	{
		var reportname="sessiondistribution";
	    var reportcontroller="usefrequency";
	    var data={ 
...
{  
	...
	{
		window.parent.deletereport("sessiondistribution");		 	 
	}
	return false;
