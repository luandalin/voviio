...
CREATE TABLE IF NOT EXISTS `umsinstall_clientdata` (
  ...
  `productkey` varchar(50) NOT NULL,
  `service_supplier` varchar(64) NOT NULL DEFAULT '中国移動通信',
...
(1, "Androidマーケット", "2011-11-22 13:54:39", 1, "system", 1, 1),
(2, "マシンのフロント市場", "2011-11-22 13:54:47", 1, "system", 1, 1),
(3, "INGの市場", "2011-11-22 13:54:57", 1, "system", 1, 1),
(4, "XDAの市場", "2011-11-22 13:55:03", 1, "system", 1, 1),
...
(2, "User", "ユーザー管理", NULL),
(3, "Product", "マイアプリ", NULL),
(4, "errorlogondevice", "エラーデバイスの統計情報", NULL),
(5, "productbasic", "アプリ統計量概要", NULL),
(6, "Auth", "ユーザー", NULL),
(7, "Autoupdate", "自動更新", NULL),
(8, "Channel", "チャンネル", NULL),
(9, "Device", "デバイス", NULL),
(10, "Event", "イベント管理", NULL),
(11, "Onlineconfig", "ポリシー送信", NULL),
(12, "Operator", "オペレーター統計量", NULL),
(13, "Os", "OSバージョン", NULL),
(14, "Profile", "プロフィール", NULL),
(15, "Resolution", "解像度統計量", NULL),
(16, "Usefrequency", "周期的使用統計量", NULL),
(17, "Usetime", "使用継続時間統計量", NULL),
(18, "errorlog", "エラーログ", NULL),
(19, "Eventlist", "イベント", NULL),
(20, "market", "チャネル統計量", NULL),
(21, "region", "地域等軽量", NULL),
(22, "errorlogonos", "OS上のエラー数", NULL),
(23, "version", "バージョン統計量", NULL),
(24, "console", "アプリケーション", NULL),
(25, "Userremain", "ユーザー滞留", NULL),
(26, "Pagevisit", "ページ訪問", NULL),
(27, "Network", "ネットワーク統計量", NULL),
(28, "funnels", "ファンネル数", NULL);
-- --------------------------------------------------------
