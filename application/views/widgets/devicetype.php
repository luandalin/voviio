...
<?php }if(isset($delete)){?>
 <a href="#" onclick="deletereport()">
	...
	<?php echo  lang('v_rpt_de_top10')?></h3>
			<ul class="tabs2">
...
{	
	 ...
	 var loading_img = $("<img src='<?php echo base_url();?>/assets/images/loader.gif'/>");
		...
		{
			var pieObj = {};
			pieObj.name = objNewUserData[i].devicebrand_name;
			pieObj.sliced = false;
...
{	
	...
	{
		var reportname="devicetype";
	    var reportcontroller="device";
	    var data={ 
...
{ 
	...
	{
		window.parent.deletereport("devicetype"); 	 	 	  
	}
	return false;
